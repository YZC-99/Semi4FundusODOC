...
CUDA_VISIBLE_DEVICES=0 python main.py -ng 1 -s 42 --config Drishti-GS/cropped_sup256x256/segformer/backbone_b5_pretrained_flip_rotate_scale_translate_noise_cutoutDCBDFCLoss_attention_sub_addv3
