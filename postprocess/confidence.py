...
num_classes = 3
pre_ckpt_path = '/root/autodl-tmp/Semi4FundusODOC/experiments/SEG/cropped_semi512x512/Teacher_Student/random1_ODOC_semi90_PretrainT_PretrainS_None/ckpt/epoch=377-val_OD_dice=0.961572.ckpt'
now_ckpt_path = '/root/autodl-tmp/Semi4FundusODOC/experiments/SEG/cropped_semi512x512/Teacher_Student/random1_ODOC_semi90_PretrainT_PretrainS_None/ckpt/epoch=419-val_OC_dice=0.868710.ckpt'

cmap = color_map('eye')
pre_model = DualDeepLabV3Plus('resnet50',num_classes)
pre_model.load_state_dict(get_sd(pre_ckpt_path))
pre_model.eval()
pre_model.to('cuda:0')

now_model = DualDeepLabV3Plus('resnet50',num_classes)
