...
CUDA_VISIBLE_DEVICES=0 python main.py -ng 1 -abs -alf --config Drishti-GS/cropped_sup512x512/res50deeplabv3plus/random1_ODOC_backbone_pretrained_flip_rotateDCBDFCLoss
