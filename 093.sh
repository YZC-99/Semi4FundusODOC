...
CUDA_VISIBLE_DEVICES=0 python main.py -ng 1 -s 42  --config Drishti-GS/cropped_sup256x256/my_segformer/attentions/backbone_multi_level/backbone_b1_pretrained_flip_rotate_translate_scale_CE_2e-1FC_Loss_v7-ii-1-9
