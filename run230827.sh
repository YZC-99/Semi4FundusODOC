...
#CUDA_VISIBLE_DEVICES=0,1 python main.py --config SEG/cropped_sup512x512/random1_ODOC_sup10_CEContrastPixelCBLLoss
CUDA_VISIBLE_DEVICES=0 python main.py -ng 1--config SEG/cropped_sup512x512/random1_ODOC_sup10_CEContrastCorrectPixelCBLLoss
