...
class SegFormerHead(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.attention == 'backbone_multi-levelv7-ii-1-6' or self.attention == 'backbone_multi-levelv7-ii-1-6-v1' \
            ...
            out_feat = _c1
        elif self.attention == 'dec_transpose_FAMIFM_DAM_Inj' or self.attention == 'dec_transpose_FAMIFM_CBAM_Inj':
            _c4 = self.center(c4)
            _c4 = F.interpolate(_c4, size=c4.size()[2:], mode='bilinear', align_corners=False)
...
if __name__ == '__main__':
    ...
    model = SegFormer(num_classes=3, phi='b2', pretrained=False,attention='dec_transpose_FAMIFM_CBAM_Inj')
