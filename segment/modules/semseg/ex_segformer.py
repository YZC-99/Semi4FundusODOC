...
class SegFormerHead(nn.Module):
    ...
    def __init__(self, num_classes=20, in_channels=[32, 64, 160, 256], embedding_dim=768, dropout_ratio=0.1,attention='subv1'):
        ...
        if self.attention == 'subv1':
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-3-v1':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels,k=3,s=1,p=1)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels,k=3,s=1,p=1)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels,k=3,s=1,p=1)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-3-v2':
            self.cca1 = CrissCrossAttention(c3_in_channels+c4_in_channels)
            self.cca2 = CrissCrossAttention(c4_in_channels+c3_in_channels+c2_in_channels)
            self.cca3 = CrissCrossAttention(c4_in_channels+c3_in_channels+c2_in_channels+c1_in_channels)

            self.linear_c1 = MLP(input_dim=c4_in_channels+c3_in_channels+c2_in_channels+c1_in_channels,embed_dim=embedding_dim)
            self.linear_c2 = MLP(input_dim=c4_in_channels+c3_in_channels+c2_in_channels,embed_dim=embedding_dim)
            self.linear_c3 = MLP(input_dim=c4_in_channels+c3_in_channels,embed_dim=embedding_dim)
            self.linear_c4 = MLP(input_dim=c4_in_channels,embed_dim=embedding_dim)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-3-v3' or attention == 'backbone_multi-levelv7-ii-1-3-v5':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
            self.cca1 = CrissCrossAttention(c3_in_channels)
            self.cca2 = CrissCrossAttention(c2_in_channels)
            self.cca3 = CrissCrossAttention(c1_in_channels)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-3-v4':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
            self.cca1 = CrissCrossAttention(c1_in_channels)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-6-v1-1':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-6-v1-2':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-6-v2':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-8':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-9':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
            ...
            self.linear_c3 = MLP(input_dim=c3_in_channels,embed_dim=embedding_dim)
            self.linear_c4 = MLP(input_dim=c4_in_channels,embed_dim=embedding_dim)
            self.linear_c5 = MLP(input_dim=c3_in_channels + c2_in_channels + c1_in_channels,embed_dim=embedding_dim)
        ...
        elif attention == 'backbone_multi-levelv7-ii-1-11':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
            ...
            self.linear_fuse = ConvModule(
                c1=c1_in_channels + c2_in_channels + c3_in_channels + c4_in_channels,
                c2=embedding_dim,
                k=1,
            )
        elif attention == 'backbone_multi-levelv7-ii-1-12':
            self.ffn1 = ConvModule(c3_in_channels+c4_in_channels,c3_in_channels)
            self.ffn2 = ConvModule(c3_in_channels+c2_in_channels,c2_in_channels)
            self.ffn3 = ConvModule(c2_in_channels+c1_in_channels,c1_in_channels)
    ...
    def forward(self, inputs):
        ...
        if self.attention == 'subv1':
            ...
            _c = self.linear_fuse(torch.cat([_c1,_c2,_c3,_c4],dim=1))
        elif self.attention == 'backbone_multi-levelv7-ii-1-3-v1':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            ...
            _c = self.linear_fuse(torch.cat([_c1,_c2,_c3,_c4],dim=1))
        elif self.attention == 'backbone_multi-levelv7-ii-1-3-v2':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            out1 = self.cca1(torch.cat([lateral_c4,lateral_c3],dim=1))
            out2 = self.cca2(torch.cat([out1,lateral_c2],dim=1))
            out3 = self.cca3(torch.cat([out2,c1],dim=1))
            _c4 = self.linear_c4(lateral_c4).permute(0,2,1).reshape(n, -1, lateral_c4.shape[2], lateral_c4.shape[3])
            _c3 = self.linear_c3(out1).permute(0,2,1).reshape(n, -1, out1.shape[2], out1.shape[3])
            _c2 = self.linear_c2(out2).permute(0,2,1).reshape(n, -1, out2.shape[2], out2.shape[3])
            _c1 = self.linear_c1(out3).permute(0,2,1).reshape(n, -1, out3.shape[2], out3.shape[3])
            ...
            _c = self.linear_fuse(torch.cat([_c1,_c2,_c3,_c4],dim=1))
        elif self.attention == 'backbone_multi-levelv7-ii-1-3-v3':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            ...
            _c = self.linear_fuse(torch.cat([_c1,_c2,_c3,_c4],dim=1))
        elif self.attention == 'backbone_multi-levelv7-ii-1-3-v4':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            c1 = self.cca1(c1)
            lateral_c2 = self.cca2(lateral_c2)
            lateral_c3 = self.cca3(lateral_c3)
        ...
        elif self.attention == 'backbone_multi-levelv7-ii-1-3-v5':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            out1 = self.ffn1(torch.cat([lateral_c4, lateral_c3], dim=1))
            _out1 = self.cca1.cross_forward(lateral_c3,out1)
            out2 = self.ffn2(torch.cat([_out1, lateral_c2], dim=1))
            _out2 = self.cca2.cross_forward(lateral_c2,out2)
            out3 = self.ffn3(torch.cat([_out2, c1], dim=1))
            # out3 = self.cca3.cross_forward(c1,out3)
            _c4 = self.linear_c4(lateral_c4).permute(0, 2, 1).reshape(n, -1, lateral_c4.shape[2], lateral_c4.shape[3])
            _c3 = self.linear_c3(out1).permute(0, 2, 1).reshape(n, -1, out1.shape[2], out1.shape[3])
            _c2 = self.linear_c2(out2).permute(0, 2, 1).reshape(n, -1, out2.shape[2], out2.shape[3])
            _c1 = self.linear_c1(out3).permute(0, 2, 1).reshape(n, -1, out3.shape[2], out3.shape[3])
        ...
        elif self.attention=='backbone_multi-levelv7-ii-1-6-v1-dam':
            c4 = self.dam(c4)
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
        ...
        elif self.attention == 'backbone_multi-levelv7-ii-1-6-v1-1':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            ...
            sub2 = _c3 - _c4
            sub = self.ffn_sub(torch.cat([sub1, sub2], dim=1))
            sub = self.cca1.cross_forward(sub1,sub)
            sub = self.cca2.cross_forward(sub2,sub)

            _c = self.linear_fuse(torch.cat([_c1, _c2, _c3, _c4, sub], dim=1))
        elif self.attention == 'backbone_multi-levelv7-ii-1-6-v1-2':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            ...
            _c = self.linear_fuse(torch.cat([_c1,_c2,_c3,_c4],dim=1))
        elif self.attention == 'backbone_multi-levelv7-ii-1-8':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            ...
            _c = self.linear_fuse(torch.cat([_c1,_c2,_c3,_c4],dim=1))
            _c = self.cca1(_c)
        elif self.attention == 'backbone_multi-levelv7-ii-1-9':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            ...
            _c = self.linear_fuse(torch.cat([_c1,_c2,_c3,_c4,_sub],dim=1))
        elif self.attention == 'backbone_multi-levelv7-ii-1-11':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
        ...
        elif self.attention == 'backbone_multi-levelv7-ii-1-12':
            # 全部上采样到128*128
            lateral_c2 = F.interpolate(c2, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c3 = F.interpolate(c3, size=c1.size()[2:], mode='bilinear', align_corners=False)
            lateral_c4 = F.interpolate(c4, size=c1.size()[2:], mode='bilinear', align_corners=False)
            ...
            sub1 = self.cca1(sub1) - sub1
            sub2 = self.cca2(sub2) - sub2

            _c = self.linear_fuse(torch.cat([_c1+sub1,_c2+sub1,_c3+sub2,_c4+sub2],dim=1))
...
if __name__ == '__main__':
    ...
    model = SegFormer(num_classes=3, phi='b2', pretrained=False,attention='backbone_multi-levelv7-ii-1-6-v1-dam')
