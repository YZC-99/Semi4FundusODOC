...
def init_loss(pl_module: pl.LightningModule):
    ...
    if pl_module.cfg.MODEL.ContrastCrossPixelCorrect_loss > 0.0:
        pl_module.ContrastCrossPixelCorrect_loss = ContrastCrossPixelCorrect(pl_module.num_classes,extractor_channel=extractor_channel,kernal_size=pl_module.MODEL.ContrastCrossPixelCorrect_kernal)
