...
def optimizer_config(pl_module: pl.LightningModule):
    ...
    if pl_module.cfg.MODEL.optimizer == 'AdamW':
        ...
        scheduler = CosineAnnealingWarmupRestarts(optimizers[0],first_cycle_steps=first_cycle_steps,cycle_mult=1.0,max_lr=pl_module.cfg.MODEL.lr,min_lr=pl_module.cfg.MODEL.lr_min * pl_module.cfg.MODEL.lr,warmup_steps=warmup_iter,gamma=pl_module.cfg.MODEL.optimizer_T_gamma)
